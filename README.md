...
Ce projet vise à analyser la réputation de l'entreprise Quicken en construisant un modèle de machine learning capable de classifier les avis clients en avis positifs ou négatifs.
...
- reviews_scrapper.py : Script de scraping des avis clients depuis TrustPilot 
...
- app.py : Interface web permettant à l'utilisateur de saisir un avis et d'obtenir la prédiction en temps réel
